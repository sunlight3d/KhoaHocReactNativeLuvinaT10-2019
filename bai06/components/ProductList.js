...
export default class ProductList extends React.Component {
    ...
    insertProduct(productId, name, year, url) {
        products.push({productId, name, year, url})
    }
    ...
    render() {
        ...
        return <View style = {styles.container}>
            <Header actionBack = {() => {
                ...
                navigation.navigate("DetailProduct", {actionType: ACTION_INSERT, insertProduct})
            }}
